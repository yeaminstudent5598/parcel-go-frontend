      ...
      <main>
          ...
          <div className="container mx-auto px-6 py-20 lg:py-24 grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight text-slate-900">
                Your Parcel, Delivered <span className="text-blue-600">Faster & Safer</span>.
              </h1>
              <p className="mt-4 max-w-lg mx-auto lg:mx-0 text-lg text-slate-600">
              ...
              <div className="mt-8 flex flex-col sm:flex-row gap-2 max-w-md mx-auto lg:mx-0">
                ...
                />
                <Button size="lg" className="h-12 bg-blue-600 hover:bg-blue-700 text-base">
          ...
          <div className="container mx-auto px-6">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
              <div>
                ...
                <p className="text-slate-500">Parcels Delivered</p>
              </div>
              <div>
              ...
              <div>
                <h3 className="text-3xl font-bold text-blue-600">64</h3>
        ...
        <section className="py-20 bg-slate-50">
          <div className="container mx-auto px-6 text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">It's That Simple</h2>
            <p className="text-lg text-slate-600 max-w-2xl mx-auto mb-12">
              Get your parcel on its way in just three easy steps.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <Card className="border-2 border-transparent hover:border-blue-500 hover:shadow-lg transition-all">
                <CardHeader>
                  <div className="mx-auto bg-blue-100 text-blue-600 rounded-xl h-16 w-16 flex items-center justify-center mb-4">
                    <FileText className="h-8 w-8" />
                  </div>
                  <CardTitle>1. Book Your Parcel</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-slate-600">Provide details online and schedule a pickup time that works for you.</p>
                </CardContent>
              </Card>
              <Card className="border-2 border-transparent hover:border-blue-500 hover:shadow-lg transition-all">
                <CardHeader>
                ...
                <CardContent>
                  <p className="text-slate-600">Our agent collects the parcel right from your location, hassle-free.</p>
                </CardContent>
              </Card>
              <Card className="border-2 border-transparent hover:border-blue-500 hover:shadow-lg transition-all">
                <CardHeader>
                ...
                <CardContent>
                  <p className="text-slate-600">Follow your parcel's journey online until it reaches its destination safely.</p>
                </CardContent>
              </Card>
            </div>
          </div>
        ...
        size="lg" 
        variant="secondary" 
        className="bg-white text-blue-600 hover:bg-slate-200"
        onClick={() => navigate('/register')} // <-- এই লাইনটি যোগ করুন
    >
        Register for Free
