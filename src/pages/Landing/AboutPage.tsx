    ...
    <div className="bg-white dark:bg-slate-900  text-slate-800 dark:text-slate-100">
      ...
      <section className="py-16 lg:py-24 bg-slate-50 dark:bg-slate-800">
        <div className="container mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-slate-900 dark:text-slate-100 mb-4">Our Story</h2>
      ...
      <section className="py-16 lg:py-24">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-12 text-slate-900 dark:text-slate-100">Our Core Values</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="flex flex-col items-center">
              <div className="bg-blue-100 text-blue-600 dark:bg-blue-900 dark:text-blue-400 p-4 rounded-full mb-4">
                <Rocket className="h-8 w-8" />
              </div>
              <h3 className="text-xl font-semibold mb-2">Speed</h3>
              <p className="text-slate-600 dark:text-slate-300">We prioritize efficiency to ensure your parcels reach their destination in the shortest possible time.</p>
            </div>
            <div className="flex flex-col items-center">
              <div className="bg-blue-100 text-blue-600 dark:bg-blue-900 dark:text-blue-400 p-4 rounded-full mb-4">
              ...
              <p className="text-slate-600 dark:text-slate-300">Your trust is our biggest asset. We handle every package with the utmost care and responsibility.</p>
            </div>
            <div className="flex flex-col items-center">
              <div className="bg-blue-100 text-blue-600 dark:bg-blue-900 dark:text-blue-400 p-4 rounded-full mb-4">
              ...
              <p className="text-slate-600 dark:text-slate-300">We are committed to providing exceptional service and support to meet your needs.</p>
            </div>
            <div className="flex flex-col items-center">
              <div className="bg-blue-100 text-blue-600 dark:bg-blue-900 dark:text-blue-400 p-4 rounded-full mb-4">
              ...
              <p className="text-slate-600 dark:text-slate-300">Our success is driven by the collaborative spirit of our dedicated team across the nation.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 lg:py-24 bg-slate-50 dark:bg-slate-800">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-12 text-slate-900 dark:text-slate-100">Meet Our Team</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="text-center border-0 shadow-lg bg-white dark:bg-slate-700 text-slate-800 dark:text-slate-100">
            ...
            <Card className="text-center border-0 shadow-lg bg-white dark:bg-slate-700 text-slate-800 dark:text-slate-100">
              <CardContent className="p-6">
                ...
                <p className="text-blue-600 dark:text-blue-400">Technology Lead</p>
              </CardContent>
            </Card>
             <Card className="text-center border-0 shadow-lg bg-white dark:bg-slate-700 text-slate-800 dark:text-slate-100">
              <CardContent className="p-6">
                ...
                <p className="text-blue-600 dark:text-blue-400">Customer Support Head</p>
              </CardContent>
            </Card>
          </div>
        </div>
